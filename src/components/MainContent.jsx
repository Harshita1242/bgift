...
export default function MainContent() {
    ...
    const pages = [
        ...
        <StoryPage key="cover" backgroundColor="bg-gradient-to-br from-rose-200 to-purple-200">
            <div className="flex flex-col items-center justify-center h-full text-center">
                ...
                <div className="text-2xl md:text-3xl text-purple-700 mb-8 relative z-10">
                    Hey Cutieee patootiee, you are<br />my<FlipWords words={['Cutieeee', 'Shonaaa', 'Babygurl', 'Chota bachaa', 'Chirkutt']} className="text-nowrap" />
                </div>
                <motion.button
                    whileHover={{ scale: 0.69}}
                    whileTap={{ scale: 0.95 }}
        ...
        <StoryPage key="journey" backgroundColor="bg-gradient-to-br from-blue-200 to-green-200">
            <h2 className="text-3xl font-bold text-blue-600 mb-6 relative z-10">Yoursss !!!</h2>
            <div className="space-y-4 flex-1 overflow-y-auto overflow-x-hidden rounded-xl custom-scrollbar">
                {[
                    { date: '15 July 2004', event: 'The Cutest Day......When a cute little girl born...', emoji: '❤️', text: 'When a cute little girl born...', img: 'public/hi.jpg' },
                    { date: '01 August 2021', event: 'Came in contact with a boy...', emoji: '🤐', text: '', img: '/movie.jpg' },
                    { date: '12 January, 2022', event: 'Occupied by that boy', emoji: '🤗', text: '', img: '/hug.jpg' },
                    { date: 'Going on', event: '', emoji: '✈️', text: 'Status', img: '/trip.jpg' },
                ]
                    .map((item, index) => (
                        <motion.div
                            key={index}
            ...
            <div className="bg-white rounded-xl p-6 shadow-md overflow-y-auto flex-1 custom-scrollbar">
                <div className="relative z-10">
                    <div className="text-gray-700 text-lg leading-relaxed mb-4">
                        <p>First of all,</p>
                        <h1>"Happpppiiiiieeeesstttttttttt Birthdayyyyyyyyyyyyyyy"</h1>
                        <p>I know this isn't a very good Gift but take it as the side gift. This lasts forever and it's yourrr birthdayy yayyyyyyy feeling excited....You are the cutest pocket-sized human i have ever met🥹UMMMMmm.... </p>
                        <p>Your smile could end wars....<br/>Your face calms like crashing shores...<br/>You speaks the language that my heart obeys....<br/>Smile...you are someone's light in darker days...</p>
                        <p>I don’t even know where to start, but I’ll try.
You are seriously the cutest person I know — with your adorable little height, that bunny face, and your smile that could make any bad day better.
I love how you always do little things for me, even when you don’t realize it. It honestly means so much to me.

I’m so lucky to have you in my life. You make everything brighter. I hope your day is as amazing as you are.</p>
                    </div>
        ...
        <StoryPage key="final" backgroundColor="bg-gradient-to-br from-pink-100 to-blue-200">
            <div className="flex flex-col items-center justify-center h-full text-center">
                <h2 className="text-4xl font-bold text-pink-600 mb-6 relative z-10">Continues...</h2>
