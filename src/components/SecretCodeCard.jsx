...
export default function SecretCodeCard({ onCorrect }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (code === '0.01') {
            ...
            setError("Iss see aurrr chotii ho tum (Try Again)")
    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                <h2 className="text-xl font-medium text-gradient mb-4 text-center relative z-10">Brainstorming!!</h2>
                <h2 className="text-xl font-medium text-gradient mb-4 text-center relative z-10">What is your Height(in mm)</h2>
